...
from obj.corpus import InCorpus
...
def clean_info(infile, outfile, ranges,
	...
	nelts = len(infile.readline().strip().split())
    allowed = ranges_to_set(ranges, nelts, include_zero=True)
...
if __name__ == "__main__":
    ...
    with codecs.open(parser.infile, "r", parser.ienc or parser.enc) as infile, codecs.open(parser.outfile, "w", parser.oenc or parser.enc) as outfile:
    	clean_info(infile, outfile, parser.ranges,
